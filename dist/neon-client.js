var NeonBundle = (() => {
  ...
  var init_serverless = __esm({
    "node_modules/@neondatabase/serverless/index.mjs"() {
      ...
      oo = (r, e, t) => e in r ? Ce(r, e, { enumerable: true, configurable: true, writable: true, value: t }) : r[e] = t;
      ...
      Te = (r, e, t) => (t = r != null ? to(io(r)) : {}, An(e || !r || !r.__esModule ? Ce(t, "default", {
        value: r,
        enumerable: true
      }) : t, r));
      N = (r) => An(Ce({}, "__esModule", { value: true }), r);
      _ = (r, e, t) => oo(r, typeof e != "symbol" ? e + "" : e, t);
      In = I((nt) => {
        "use strict";
        p();
        nt.byteLength = uo;
...
`);
      ...
      Js = Te(gt());
      Qe = Te(Ct());
      En = class En2 extends Tt.Client {
        constructor(t) {
          super(t);
          this.config = t;
        }
  ...
  // src/neon-client.js
  var require_neon_client = __commonJS({
    "src/neon-client.js"() {
      init_serverless();
      document.addEventListener("DOMContentLoaded", () => {
        window.neonClient = Ys;
        window.neon = Ys;
...
@neondatabase/serverless/index.mjs:
  ...
  *)
*/
//# sourceMappingURL=neon-client.js.map
